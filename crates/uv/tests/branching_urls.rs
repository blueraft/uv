...
fn branching_urls_of_different_sources_disjoint() -> Result<()> {
    ...
    dependencies = [
        ...
        { name = "iniconfig", version = "2.0.0", source = { git = "https://github.com/pytest-dev/iniconfig", revision = "93f5930e668c0d1ddf4597e38dd0dea4e2665e7a" }, marker = "python_version >= '3.12'" },
    ]
    ...
    name = "iniconfig"
    version = "2.0.0"
    source = { git = "https://github.com/pytest-dev/iniconfig", revision = "93f5930e668c0d1ddf4597e38dd0dea4e2665e7a" }
    "###);
